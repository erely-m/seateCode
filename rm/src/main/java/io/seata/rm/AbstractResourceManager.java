...
public abstract class AbstractResourceManager implements ResourceManager {
    ...
    public Long branchRegister(BranchType branchType, String resourceId, String clientId, String xid, String applicationData, String lockKeys) throws TransactionException {
        try {
            BranchRegisterRequest request = new BranchRegisterRequest(); //分支注册请求
            request.setXid(xid);
            ...
            BranchRegisterResponse response = (BranchRegisterResponse) RmRpcClient.getInstance().sendMsgWithResponse(request); //发送分支注册请求
    ...
    @Override
    public void registerResource(Resource resource) { //资源注册 发送资源组以及资源ID给TC 及服务端
