...
public class GlobalTransactionalInterceptor implements ConfigurationChangeListener,MethodInterceptor {
    ...
    @Override
    public Object invoke(final MethodInvocation methodInvocation) throws Throwable { //带有@GlobalTransactional注解的方法实际执行
        ...
        if (!disable && globalTransactionalAnnotation != null) {
            return handleGlobalTransaction(methodInvocation, globalTransactionalAnnotation); //全局事务开启
    ...
    private Object handleGlobalTransaction(final MethodInvocation methodInvocation,
        ...
        try {
            return transactionalTemplate.execute(new TransactionalExecutor() {
                ...
                public Object execute() throws Throwable {
                    return methodInvocation.proceed(); //具体业务执行
                }
        ...
        } catch (TransactionalExecutor.ExecutionException e) { //捕获异常进行处理
