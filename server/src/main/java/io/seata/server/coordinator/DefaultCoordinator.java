...
public class DefaultCoordinator extends AbstractTCInboundHandler
    ...
    protected void doBranchRegister(BranchRegisterRequest request, BranchRegisterResponse response,
                                    RpcContext rpcContext) throws TransactionException { //分支注册
    ...
    @Override
    protected void doBranchReport(BranchReportRequest request, BranchReportResponse response, RpcContext rpcContext) //分支状态报告
        throws TransactionException {
