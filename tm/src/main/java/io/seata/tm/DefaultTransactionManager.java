...
public class DefaultTransactionManager implements TransactionManager {
    ...
    @Override
    public String begin(String applicationId, String transactionServiceGroup, String name, int timeout) //请求TC记录全局事务开始
    ...
    @Override
    public GlobalStatus commit(String xid) throws TransactionException { //提交事务
